    ...
    <section className="flex-row items-center gap-8 md:gap-12">
      <div className="flex flex-col items-center text-center border-b">
         <Avatar className="w-24 h-24 md:w-32 md:h-32 mb-4 shadow-lg">
            <AvatarImage src="https://avatars.githubusercontent.com/u/35253747" alt="Justin Koay Tze Ji" />
            <AvatarFallback>J</AvatarFallback>
        </Avatar>
        <h1 className="text-2xl md:text-3xl font-bold mb-1">Justin Koay Tze Ji</h1>
        <p className="text-muted-foreground mb-4">Data Scientist</p>

        <div className="flex justify-center gap-4 mb-6">
            <Button variant="outline" size="icon" asChild>
                <a href="https://github.com/justintzeji" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                    <Github className="h-5 w-5" />
                </a>
            </Button>
            <Button variant="outline" size="icon" asChild>
                <a href="https://linkedin.com/in/justintzeji" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
